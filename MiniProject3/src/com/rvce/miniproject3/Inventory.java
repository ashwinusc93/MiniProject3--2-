        ...
        search.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
               ...
               //boolean b= area.equals("") && drugname.equals("");
                ...
                if(med_id.length()==0)
                {
                     Toast.makeText(Inventory.this, "Blank Field..Please Enter", Toast.LENGTH_LONG).show();
                }
                ...
                try {
                    ...
                    httppost = new HttpPost("http://192.168.43.96:6886/inventory.php");
                    // Add your data
                ...
                {
                    Toast.makeText(Inventory.this, "error"+e.toString(), Toast.LENGTH_LONG).show();
                }
